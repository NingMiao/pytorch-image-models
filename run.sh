...
#Train model and Li
python3 train.py /mnt/ssd/imagenet/ --device tpu-8 --experiment resnet-50-Li-test --batch-size 256 -Li_config_path ../InstaAug/InstaAug_module/configs/config_crop_supervised_imagenet.yaml -entropy_parameter 1.0  --pretrained --epochs 200 -Li_lr 1.0 -Li_loss crossentropy -batch_amount 0 -train_only --scale 0.8 1.0 --warmup-epochs 0 -save_every 3 --start-epoch 170 -Li_optimizer adam -target_entropy 2.0 -no_Li_scheduler