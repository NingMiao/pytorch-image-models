...
#python3 train.py /mnt/ssd/imagenet/ --model resnet50 --device tpu-8 --experiment resnet-50-test --batch-size 16 --lr 0.2 --warmup-epoch 0 --cooldown-epochs 0 --sched step --decay-epochs 30 --color-jitter 0.0 -save_every 3 --resume output/train/resnet-50-random_crop_from_scratch_continued/model39.ckpt --start-epoch 40 --cooldown-epochs 0 --scale 0.8 1.0 --epochs 41  -Li_config_path ../InstaAug/InstaAug_module/configs/config_crop_supervised_imagenet_new_param.yaml -resume_Li output/train/resnet-50-new_param_new_entropy_train_Li_only/Li62.ckpt -eval_only
